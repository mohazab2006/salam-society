    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
      <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 space-y-4">
        ...
        <div>
          ...
          <input name="title" value={form.title} onChange={handleChange} required placeholder="Program title" className={inputClass} />
        </div>
        <div>
        ...
        <div>
          ...
          <textarea name="description" value={form.description} onChange={handleChange} required rows={5} placeholder="Describe the program..." className={inputClass} />
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 space-y-4">
        ...
        <div>
          ...
          <input name="age_group" value={form.age_group} onChange={handleChange} placeholder="e.g. 13–18, Adults, All ages" className={inputClass} />
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 space-y-4">
        ...
        <div>
          ...
          <input name="schedule" value={form.schedule} onChange={handleChange} required placeholder="e.g. Every Friday, 6:00 PM – 8:00 PM" className={inputClass} />
        </div>
        <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 space-y-4">
        ...
        <label className="flex items-center gap-3 cursor-pointer">
          <input type="checkbox" name="signup_required" checked={form.signup_required} onChange={handleChange} className="w-4 h-4 accent-orange-brand" />
