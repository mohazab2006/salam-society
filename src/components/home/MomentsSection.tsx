...
function MediaItem({ item }: { item: Media }) {
  ...
  return (
    <>
      <motion.div
        className={`relative overflow-hidden rounded-2xl bg-gray-100 cursor-pointer group ${isVertical ? "row-span-2" : ""}`}
      ...
      <div className="container-custom">
        ...
        >
          <div>
            ...
            >
              {m.title}{" "}
              <span className="text-orange-brand">{m.titleHighlight}</span>
            </h2>
