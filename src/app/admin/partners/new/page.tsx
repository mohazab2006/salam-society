  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Add a mosque or organization to the partners section.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
        <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 space-y-4">
          <div>
            ...
            <input name="name" value={form.name} onChange={handleChange} required placeholder="e.g. Kanata Muslims" className={inputClass} />
          </div>
          <div>
            <label className={labelClass}>Logo URL *</label>
            <input name="logo_url" value={form.logo_url} onChange={handleChange} required type="url" placeholder="https://..." className={inputClass} />
          </div>
          <div>
            <label className={labelClass}>Website URL (optional)</label>
            <input name="website_url" value={form.website_url} onChange={handleChange} type="url" placeholder="https://..." className={inputClass} />
          </div>
          <div>
